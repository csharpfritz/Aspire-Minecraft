...
**Why:** Jeff wants the tower centered on the village and positioned as a landmark north of town, with the entrance welcoming players as they look south toward the village. The 15-block gap between tower and fence gives clean sightlines and prevents the tower from crowding the fence perimeter.
...
**What:** Added `paths-ignore` filters to build.yml, release.yml, and codeql.yml to skip CI/CD pipelines when only documentation files change. Ignored paths: `docs/**`, `user-docs/**`, `*.md` (root-level), `.squad/**`.
...
- Add decision log: `.squad/decisions/inbox/rhodey-mca-inspector-architecture.md`
...
- **Updated:** `.squad/agents/mantis/history.md` (appended 4 new learnings)
...
5. Create decision doc: `.squad/decisions/inbox/rhodey-nbt-library-evaluation.md`
