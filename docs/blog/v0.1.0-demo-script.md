...
- [ ] A code editor open to `samples/GrandVillageDemo/GrandVillageDemo.AppHost/Program.cs`
...
Open `samples/GrandVillageDemo/GrandVillageDemo.AppHost/Program.cs` and walk through it:
